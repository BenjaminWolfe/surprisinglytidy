...
output:
  xaringan::moon_reader:
    ...
    nature:
      ...
      beforeInit: "libs/pre-process.js"
---

background-image: url(https://upload.wikimedia.org/wikipedia/commons/b/be/Sharingan_triple.svg)

```{r setup, include=FALSE}
options(htmltools.dir.version = FALSE) # From the original Hello Ninja pres
# Copy the pre-processing JS file mentioned in the YAML
file.copy(
  from = system.file(
    "rmd", "h", "js",
    "pre-process.js",
    package = "surprisinglytidy"
  ),
  to = file.path(
    knitr::opts_knit$get("output.dir"), "libs",
    "pre-process.js"
  ),
  overwrite = TRUE, recursive = TRUE
)
# Add a test CSS file.
# Later we'll do quite a bit more with this, processing Sass into CSS first.
surprisinglytidy::add_dependency(
 "testy-css",
 packageVersion("surprisinglytidy"),
 file = "testy.css",
 path = "rmd/h/css"
)
# Show how we can set classes for all R output in Xaringan...
knitr::opts_chunk$set(
  render        = surprisinglytidy::render_chunk,
  class.source  = ".r-source",
  class.warning = ".r-warning",
  class.message = ".r-message",
  class.error   = ".r-error",
